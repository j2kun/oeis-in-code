...
**[oeis.org/A000045](oeis.org/A000045)**

- **54** distinct line(s) of code
...
- Content:
  ```
  | [36](https://www.erdosproblems.com/36) | no | open | [yes](https://github.com/google-deepmind/f...
  ```
...
- Content:
  ```
  %H A389690 Rui Yao, <a href="https://oeis.org/A389690/a389690_2.txt">Python program</a>
  ```
...
- Content:
  ```
  https://oeis.org/A357234 a(n) is the maximum length of a snake-like polyomino in an n X n square ...
  ```
...
- Content:
  ```
  43 | [A353463](https://loda-lang.org/edit/?oeis=353463) (47) | [A353463](https://oeis.org/A353463...
  ```
...
## 3. Most Common Matched String (Filtered)

*Excludes repos in repos_to_skip.txt*

**[oeis.org/A000045](oeis.org/A000045)**

- **46** distinct line(s) of code
...
## 4. Top 20 Highest OEIS Numbers (Filtered)
...
- Content:
  ```
  __Integer sequences.__ The [decades-old](https://oeis.org/wiki/Welcome#OEIS:_Brief_History), freq...
  ```
